...
testRouter.use(validationBearerTokenMiddleware_1.default);
testRouter.post('/test', (0, validateSchemaMiddleware_1.default)(testSchema_1.testSchema), testController.insert);
